    ...
    handleCheckBoxes(e) {
        if(e.target.checked) {
            this.setState(prevState => ({
                numberChecked: prevState.numberChecked + 1,
                data: {
                    datasets: [{
                        labels: "Usage of services",
                        data: [prevState.data.datasets[0].data[0]-1, prevState.data.datasets[0].data[1]+1],
                        backgroundColor: this.chartBGColors,
                        borderColor: this.chartBorderColors,
                        borderWidth: 1
                    }]
                    ...
                    <div className="welcomeMsg col-sm-12 col-md-6">
                        ...
                        <ul className = "reportsNotificationList">
                            <li className = "reportsNotification">
                                <input type="checkbox" defaultChecked={true} onChange={(e) => this.handleCheckBoxes(e)} />
                                <span className = "listDetail">Application Development</span>
                            </li>
        
                            <li className = "reportsNotification">
                                <input type="checkbox" defaultChecked={true} onChange={(e) => this.handleCheckBoxes(e)} />
                                <span className = "listDetail">Application Maintenance</span>
                            </li>
        
                            <li className = "reportsNotification">
                                <input type="checkbox" onChange={(e) => this.handleCheckBoxes(e)} />
                                <span className = "listDetail">Application Testing</span>
                            </li>
        
                            <li className = "reportsNotification">
                                <input type="checkbox" onChange={(e) => this.handleCheckBoxes(e)} />
                                <span className = "listDetail">Application Security</span>
                            </li>
        
                            <li className = "reportsNotification">
                                <input type="checkbox" onChange={(e) => this.handleCheckBoxes(e)} />
                                <span className = "listDetail">Staff Augmentation</span>
                            </li>
                        </ul>
                    </div>
