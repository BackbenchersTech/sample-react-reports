    ...
    render() {
        return (
            <div className = "ReportStyle1Class">
                ...
                <BootstrapTable data={this.state.list} striped hover pagination search multiColumnSearch exportCSV selectRow={ this.selectRowProp } cellEdit={ this.cellEditProp } options={this.options} 
